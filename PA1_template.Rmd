...
2.and 3. Filling in all of the missing values in the dataset with the mean for the same 5-minute interval  
...
with(averageStepsDay, plot(averageStepsDay$date, averageStepsDay$`mean(steps, na.rm = TRUE)`, pch=19, col="black", xlab="day", ylab="Mean of number of steps per day"))
